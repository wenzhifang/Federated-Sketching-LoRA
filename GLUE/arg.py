...
def parse():
    ...
    parser.add_argument('--sketching_ratio',     default=0.5,      type=float)
...
def parse_stack():
    ...
    parser.add_argument('--clients',    default=10,       type=int) #
    parser.add_argument('--seed',       default=0,          type=int)
    parser.add_argument('--eval-freq',  default=1,         type=int) #1 for stack 5 for others
    parser.add_argument('--eval-frac',  default=1,        type=float)
    #
    parser.add_argument('--server-opt',       default='adam',  type=str)
    parser.add_argument('--server-lr',        default=5e-4,    type=float)
    parser.add_argument('--server-batch',     default=10,       type=int) #
    parser.add_argument('--server-rounds',    default=20,      type=int) # 10 for stack 200 for others
    parser.add_argument('--client-lr',        default=5e-4,    type=float)
    parser.add_argument('--client-batch',     default=16,      type=int) 
    parser.add_argument('--client-epochs',    default=10,       type=int) #20 for stack 1 for others
    parser.add_argument('--lora_r',     default=16,      type=int)
    parser.add_argument('--lora-alpha', default=1, type=int)
    parser.add_argument('--sketching_ratio',     default=1,      type=float) # this will be set in the method file
